...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-133172270-1"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());

gtag('config', 'UA-133172270-1');
</script>
		<?php wp_head(); //削除禁止 ?>
<meta name="google-site-verification" content="fYHXhW5kEvw6bZirDyg4a1JN5Hv2hfe2u8Fea7cUaJE" />
	</head>
	<body <?php body_class(); ?>>
		<div id="container">
			<header class="header<?php if(get_option('center_logo_checkbox')) echo ' header--center'; ?>">
				...
				<div id="inner-header" class="wrap cf">
					...
					<?php //END ロゴまわり
						  //PC用ヘッダーナビ
						if(!wp_is_mobile() && has_nav_menu('desktop-nav')) {
